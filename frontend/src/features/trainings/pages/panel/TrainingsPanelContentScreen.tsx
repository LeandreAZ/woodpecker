import { TrainingsQueryState } from '../../state/TrainingsQueryState';
import { useEffect, useRef } from 'react';
import type { CyclePuzzle, TrainingPuzzle, View } from '../../types/training.types';
import { DashboardOverviewView } from '../../../dashboard/pages/DashboardOverviewView';
import { DetailView } from '../detail/TrainingsDetailView';
import CreateTrainingView from '../create/TrainingsCreateView';
import EditTrainingView from '../edit/TrainingsEditView';
import SolverView from '../../../solver/pages/SolverView';
import { TrainingsStatsView } from '../../../statistics/pages/StatisticsView';
import type { useTrainingsPanelState } from '../../state/useTrainingsPanelState';
import '../../styles/trainings-common.css';
