...
import TrainingsAppShell from '../../../../app/layout/trainings/TrainingsAppShell';
import { useTrainingsPanelRouting } from '../../hooks/useTrainingsPanelRouting';
import { useTrainingsPanelState } from '../../state/useTrainingsPanelState';
