...
function TrainingsWorkspaceLayout({
  activeView,
  children,
          ...
          {navigationItems.map((item) => {
            ...
            return (
              <button
                ...
                className={`trainings-nav__item${isActive ? ' is-active' : ''}`}
                disabled={disabled}
                title={item.label}
                type="button"
      ...
      <div className="trainings-shell__content">
        {activeView !== 'dashboard' ? (
          <TrainingsRouteBar
            ...
            currentCycleStatusLabel={currentCycleStatusLabel}
            route={route}
...
export type { TrainingsShellProps };
export { TrainingsWorkspaceLayout };
export default TrainingsWorkspaceLayout;
