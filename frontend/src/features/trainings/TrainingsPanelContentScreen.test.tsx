...
vi.mock('./TrainingsSolverView', () => ({ default: ({ userSettingsOverview }: { userSettingsOverview?: { solverPreferences: { showCoordinates: boolean; showLegalMoves: boolean } } }) => <div data-testid="solver-preferences">{JSON.stringify(userSettingsOverview?.solverPreferences)}</div> }));
