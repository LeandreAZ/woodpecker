...
import type { HistoryActivityType, HistoryFilterPreset, HistoryItemStatus, HistoryOverview, HistoryTimelineItem } from './trainingsTypes';
import './history.css';
...
function TrainingsHistoryViewV2({ errorMessage, historyOverview, initialFilterPreset, isError, isLoading, onInitialFilterPresetApplied }: TrainingsHistoryViewProps) {
  ...
  useEffect(() => {
    ...
    setFilters((current) => ({ ...current, ...initialFilterPreset }));
    setPage(1);
...
export { TrainingsHistoryViewV2 };
export default TrainingsHistoryViewV2;
